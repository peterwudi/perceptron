...
create_clock -name {OSC1_50} -period 1.818 -waveform { 0.000 0.909 } [get_ports {OSC1_50}]
create_clock -name {OSC2_50} -period 1.818 -waveform { 0.000 0.909 } [get_ports {OSC2_50}]
